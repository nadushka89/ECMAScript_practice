...
// function mergeArrays1() {
//     const arrR = arguments;
//     let res = [];
//     arrR.array.array.forEach(element => {
//         element;
//     });
//     return res;
// }
...
function removeDuplicatesSet(...args) {
...
console.log(getEvenNumbers([2, 3, 5, 6, 7, 9]));
...
console.log(capitalizeFirstLetter('я пошла мыть посуду'));

const capitalizeFirstLetter1 = (str) => {
  return str.replace(/(^|\s)\S/g, (a) => a.toUpperCase());
};

console.log(capitalizeFirstLetter1('привет, дорогой друг!'));
...
console.log(capitalizeFirstLetter('качестве аргумента , и возвращает новую строку, в которой первая'));
...
let addOneWay = createCalculator(1);
let addOtherWay = createCalculator(2);
...
function createPasswordChecker(passwordLen) {
  return (password) => {
